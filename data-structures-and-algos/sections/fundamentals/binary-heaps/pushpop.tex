\subsection{Push-Pop and Pop-Push}
...
\begin{multicols}{2}
    \begin{lstlisting}[language={Python}, caption={
        Sample Python implementation and driver code for \emph{pop-push} on a max-heap, implemented using a list. For \ttd{sift_down}, refer to \cref{lst:fundamentals--binary-heaps--pop}.
    ...
    \columnbreak
    \begin{lstlisting}[language={Python}, caption={
        Similar to \cref{lst:fundamentals--binary-heaps--pushpop}, but for \emph{pop-push}.
        \linebreak
        \linebreak
    }]
    # PRECONDITION: len(heap) > 0
