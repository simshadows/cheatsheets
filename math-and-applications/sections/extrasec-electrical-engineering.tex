...
\begin{multicols}{2}
    ...
    \CheatsheetEntryFrameStart{
        ...
        \begin{circuitikz}
            ...
            ;
            \draw[simshadows/style/magneticcouplingarrow]
...
\begin{multicols}{2}
    ...
    \CheatsheetEntryFrame{
        ...
        \renewcommand{\MyReusableFormatting}[4]{%
            \begin{center}
            \begin{circuitikz}
                \begin{scope}[shift={(0,0)}]
                    \draw % Left Side
    ...
    \CheatsheetEntryFrame{
        ...
        \Exn{(Note: The reference polarity here is always with current entering the positive terminal. This is not always be the case.)}
        ...
        \renewcommand{\MyReusableFormattingB}[2]{
            \begin{center}
            \begin{circuitikz}
...
\begin{multicols}{2}
    ...
    \CheatsheetEntryFrame{
        ...
        \textbf{Case 1:} Current flows into the \ul{the same} dot. \\[0mm]
        ...
        \renewcommand{\MyReusableFormatting}[1]{
            \begin{center}
            \begin{circuitikz}
                \draw
                    (0,0)
