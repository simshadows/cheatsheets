...
\label{sec:mathgeneral}
    ...
    \newpage
    \LoadCheatsheet{mathematics-general/04-single-variable-calculus}
    \newpage
    \LoadCheatsheet{mathematics-general/05-common-integrals}
    \newpage
    \LoadCheatsheet{mathematics-general/06-multivar-and-vec-calculus}
    \newpage
    \LoadCheatsheet{mathematics-general/07-differential-equations}
    \newpage
    \LoadCheatsheet{mathematics-general/08-complex-analysis}
...
\label{sec:ee-circuit-analysis}
    ...
    \newpage
    \LoadCheatsheet{electrical-engineering-circuit-analysis/2d-frequency-response}
    \newpage
