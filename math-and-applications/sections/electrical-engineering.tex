...
\begin{multicols}{2}
    ...
    \CheatsheetEntryFrame{
        ...
        \renewcommand{\MyReusableFormattingB}{\path (-0.9,0) -- (0,0) (-0.65,-1) -- (0.65,-1);} % Ghetto alignment
...
\begin{multicols}{2}
    ...
    \CheatsheetEntryFrame{
        ...
        \renewcommand{\MyReusableFormatting}{
...
\newpage
\begin{multicols}{2}
    \Todo{Look into magnetically coupled devices.}
\end{multicols}
\newpage
\begin{multicols}{2}
