...
\begin{multicols}{2}
    ...
    \begin{CheatsheetEntryFrame}
        ...
        \newcommand{\MyReusableFormatting}[5]{ % This will be used for content
            %\vspace*{1ex}
        ...
        \newcommand{\MyReusableFormattingB}{ % This will be used for separators
            {\color{lightgray} \hrule{}}
        }
        \newcommand{\MyReusableFormattingC}{ % This will be used for special separators
            \MyReusableFormattingB%
            \vspace*{2.5pt}%
            \MyReusableFormattingB
        }

        \newcommand{\X}{{\cellcolor{myred}\color{white}$\bm{0}$}} % Used for logical low
        \newcommand{\Y}{{\cellcolor{mygreen}\color{white}$\bm{1}$}} % Used for logical high

        \renewcommand{\W}[1]{{\cellcolor{black}\color{white}$\bm{#1}$}} % Used for headings

        \newcommand{\VRuleA}{\vrule width 3pt}
